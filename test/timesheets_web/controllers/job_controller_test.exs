defmodule TimesheetsWeb.JobControllerTest do
  ...
  @create_attrs %{budget: 42, description: "some description", job_code: "some job_code"}
  @update_attrs %{budget: 43, description: "some updated description", job_code: "some updated job_code"}
  @invalid_attrs %{budget: nil, description: nil, job_code: nil}
